...
public interface IWorkItemRepository
{
    ...
    /// <summary>RN-GTE-015: minutos y puntos de presupuesto segun matriz complejidad x nivel (null si no hay fila).</summary>
    ...
    /// <summary>RN-GTE-008: el otro item En Proceso del asignado (null si no hay).</summary>
    Task<int?> ObtenerItemEnProcesoDeAsignadoAsync(int idAsignado, int idExcluido, CancellationToken cancellationToken = default);

    /// <summary>RN-GTE-010: avance registrado y revisiones que bloquean el cierre.</summary>
